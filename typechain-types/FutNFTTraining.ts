...
export interface FutNFTTrainingInterface extends utils.Interface {
  contractName: "FutNFTTraining";
  functions: {
...
export interface FutNFTTraining extends BaseContract {
  contractName: "FutNFTTraining";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FutNFTTrainingInterface;
